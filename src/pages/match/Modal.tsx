                  ...
                  >
                    ...
                    <h1 className="text-2xl font-bold text-center p-1">{events.sportName}</h1>
                     ...
                     <h3 className=" text-4xl font-bold ">Score:</h3>
                      <h3 className="text-l ml-5 font-bold">{renderScore()}</h3>
                     </div>
                      <p className="p-1 text-zinc-900">Match Location : {events.location}</p>
                      <p className=" p-1 text-zinc-900">Starting Time : {events.startsAt}</p>
